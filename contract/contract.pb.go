...
var file_contract_contract_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x69, 0x74,
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x69, 0x75, 0x78, 0x30, 0x30, 0x34, 0x37,
	0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x2d, 0x74,
	0x65, 0x73, 0x74, 0x2f, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_contract_contract_proto_goTypes = []interface{}{
	...
	(*CompositeRule)(nil),       // 3: contract.CompositeRule
...
var file_contract_contract_proto_depIdxs = []int32{
	...
	3, // 3: contract.Interaction.rules:type_name -> contract.CompositeRule
	0, // 4: contract.CompositeRule.operator:type_name -> contract.CompositeRule.Operator
	4, // 5: contract.CompositeRule.intRules:type_name -> contract.IntRule
	6, // 6: contract.CompositeRule.stringRules:type_name -> contract.StringRule
	5, // 7: contract.CompositeRule.doubleRules:type_name -> contract.DoubleRule
	3, // 8: contract.CompositeRule.nestedRules:type_name -> contract.CompositeRule
